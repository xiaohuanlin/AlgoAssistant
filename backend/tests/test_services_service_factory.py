...
class TestServiceFactory:
    ...
    def test_ai_service_creation_with_key(self):
        """Test AI service creation with OpenAI key."""
        user_config = {"openai_key": "test_openai_key"}
        factory = ServiceFactory(user_config)
        
        ai_service = factory.ai_service
        
        assert isinstance(ai_service, OpenAIService)
    
    def test_ai_service_creation_without_key(self):
        """Test AI service creation without OpenAI key."""
        user_config = {}
        factory = ServiceFactory(user_config)
    ...
    def test_create_openai_service(self):
        ...
        user_config = {"openai_key": "test_key"}
        factory = ServiceFactory(user_config)
    ...
    def test_create_openai_service_missing_config(self):
        """Test creating OpenAI service with missing configuration."""
        user_config = {}  # Missing openai_key
        factory = ServiceFactory(user_config)
