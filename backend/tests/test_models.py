...
from app.models import Record, Review, Tag, User, UserConfig
from app.schemas import RecordCreate, TagCreate, UserCreate
...
class TestUserModel:
    ...
    def test_user_config_relationship(self, db_session):
        ...
        config = UserConfig(
            user_id=user.id, leetcode_name="leetcode_user", github_repo="user/repo"
        )
