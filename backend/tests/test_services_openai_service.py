...
class TestOpenAIService:
    ...
    def test_analyze_code_success(self):
        ...
        result = service.analyze_code(
            code, user_id=1, problem_description="Two Sum", language="python"
        )
    ...
    def test_analyze_code_different_language(self):
        ...
        result = service.analyze_code(
            code, user_id=1, problem_description="Two Sum", language="java"
        )
    ...
    def test_analyze_code_rate_limit(self):
        ...
        result1 = service.analyze_code(
            code, user_id=1, problem_description="Two Sum", language="python"
        )
        result2 = service.analyze_code(
            code, user_id=1, problem_description="Two Sum", language="python"
        )
