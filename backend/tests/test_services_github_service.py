...
class TestGitHubService:
                ...
                with patch("app.services.github_service.requests.get") as mock_get:
                    ...
                    with patch("app.services.github_service.requests.put") as mock_put:
                        ...
                        mock_response.json.return_value = {
                            "commit": {
                                "html_url": "https://github.com/user/repo/commit/123"
                            }
                        }
                        mock_put.return_value = mock_response

                        result = service.push_code(
                            "test.py", "print('hello')", "Add test file"
                        )
            ...
            with patch.object(service.oauth_service, "validate_token") as mock_validate:
                ...
                with patch("app.services.github_service.requests.get") as mock_get:
                    ...
                    with patch("app.services.github_service.requests.put") as mock_put:
                        ...
                        mock_response.json.return_value = {
                            "commit": {
                                "html_url": "https://github.com/user/repo/commit/456"
                            }
                        }
                        mock_put.return_value = mock_response

                        result = service.push_code(
                            "test.py", "print('updated')", "Update test file"
                        )
    ...
    def test_push_code_no_token(self):
        ...
        with pytest.raises(Exception) as exc_info:
            service.push_code("test.py", "print('hello')", "Add test file")
