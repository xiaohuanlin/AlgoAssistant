...
class AIAnalysisRequest(BaseModel):
    """Request model for AI analysis of a single record."""

    record_id: int = Field(
        ...,
        description="ID of the record to analyze.",
    )
...
class AIAnalysisBatchRequest(BaseModel):
    """Request model for batch AI analysis of multiple records."""

    record_ids: Optional[List[int]] = Field(
        None,
        description="List of record IDs to analyze. If empty, analyzes all pending records.",
    )
...
class AIAnalysisResponse(BaseModel):
    ...
    record_id: int = Field(
        ...,
        description="ID of the analyzed record.",
    )

    analysis_result: AIAnalysisResult = Field(
        ...,
        description="AI analysis result for the record.",
    )

    analysis_status: AIAnalysisStatus = Field(
        ...,
...
class AIAnalysisBatchResponse(BaseModel):
    """Response model for batch AI analysis results."""
    ...
    skipped_analyses: int = Field(
        ...,
        description="Number of skipped analyses.",
    )

    results: List[AIAnalysisResponse] = Field(
        ...,
        description="List of analysis results for each record.",
    )


class AIAnalysisStatusResponse(BaseModel):
    """Response model for AI analysis status check."""
    ...
    last_analysis_time: Optional[datetime] = Field(
        None,
        description="Timestamp of the last analysis (if any).",
    )

    has_analysis: bool = Field(
        ...,
        description="Whether the record has been analyzed.",
    )
