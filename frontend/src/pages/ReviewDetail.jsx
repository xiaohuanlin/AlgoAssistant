  ...
  return (
    <div style={{ 
      ...
      <div style={{ 
        ...
        color: 'white',
        boxShadow: '0 20px 40px rgba(99, 102, 241, 0.15), 0 10px 20px rgba(139, 92, 246, 0.1)',
        position: 'relative',
        overflow: 'hidden'
      }}>
              ...
              <Col xs={24} md={12}>
                ...
                <div style={{ marginBottom: 24 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? 8 : 12, marginBottom: isMobile ? 8 : 12 }}>
                    ...
                    <Text strong style={{ color: '#374151', fontSize: '16px' }}>{t('review.nextReview')}</Text>
                  </div>
                  <div style={{ marginLeft: 44, fontSize: '16px', color: '#1f2937', fontWeight: 500 }}>
                    {review.next_review_date ? dayjs(review.next_review_date).format('YYYY-MM-DD HH:mm') : '-'}
                  </div>
                </div>
                ...
                <div style={{ marginBottom: 24 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? 8 : 12, marginBottom: isMobile ? 8 : 12 }}>
                    ...
                    <Text strong style={{ color: '#374151', fontSize: '16px' }}>{t('review.wrongReason')}</Text>
                  </div>
                  <div style={{ 
                    marginLeft: 44,
                    whiteSpace: 'pre-wrap', 
                ...
                <div style={{ marginBottom: 24 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? 8 : 12, marginBottom: isMobile ? 8 : 12 }}>
                    ...
                    <Text strong style={{ color: '#374151', fontSize: '16px' }}>{t('review.reviewPlan')}</Text>
                  </div>
                  <div style={{ 
                    marginLeft: 44,
                    whiteSpace: 'pre-wrap', 
              ...
              <Col xs={24} md={12}>
                <div style={{ marginBottom: 24 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? 8 : 12, marginBottom: isMobile ? 8 : 12 }}>
                    ...
                    <Text strong style={{ color: '#374151', fontSize: '16px' }}>{t('common.createdAt')}</Text>
                  </div>
                  <div style={{ marginLeft: 44, fontSize: '16px', color: '#1f2937', fontWeight: 500 }}>
                ...
                <div style={{ marginBottom: 24 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? 8 : 12, marginBottom: isMobile ? 8 : 12 }}>
                    ...
                    <Text strong style={{ color: '#374151', fontSize: '16px' }}>{t('common.updatedAt')}</Text>
                  </div>
                  <div style={{ marginLeft: 44, fontSize: '16px', color: '#1f2937', fontWeight: 500 }}>
                    {dayjs(review.updated_at).format('YYYY-MM-DD HH:mm')}
                  </div>
                </div>
                ...
                <div style={{ marginBottom: 24 }}>
                  <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? 8 : 12, marginBottom: isMobile ? 8 : 12 }}>
                    ...
                    <Text strong style={{ color: '#374151', fontSize: '16px' }}>{t('common.id')}</Text>
                  </div>
                  <div style={{ marginLeft: 44, fontSize: '16px', color: '#1f2937', fontWeight: 500 }}>
                    {review.user_id}
                  </div>
            ...
            title={
              <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? 12 : 16 }}>
                <div style={{
                  ...
                  <BellOutlined style={{ color: 'white', fontSize: isMobile ? '18px' : '20px' }} />
                </div>
                <span style={{ fontSize: isMobile ? '18px' : '20px', fontWeight: 600, color: '#1f2937' }}>{t('review.notification')}</span>
              </div>
            }
            style={{ 
              borderRadius: isMobile ? '12px' : '16px',
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: isMobile ? 16 : 24 }}>
              <div>
                <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? 8 : 12, marginBottom: isMobile ? 8 : 12 }}>
                  <div style={{
                    ...
                    height: '28px',
                    borderRadius: '6px',
                    background: getStatusColor(review.notification_status) === 'green' ? 
                  ...
                  <Text strong style={{ color: '#374151', fontSize: isMobile ? '14px' : '15px' }}>{t('review.notificationStatus')}</Text>
                </div>
                <div style={{ marginLeft: isMobile ? 32 : 40 }}>
                  ...
                  >
                    {t(`review.status.${review.notification_status}`, review.notification_status)}
                  </Tag>
                </div>
              </div>
              ...
              <div>
                <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? 8 : 12, marginBottom: isMobile ? 8 : 12 }}>
                  ...
                  <Text strong style={{ color: '#374151', fontSize: isMobile ? '14px' : '15px' }}>{t('review.notificationType')}</Text>
                </div>
                <div style={{ marginLeft: isMobile ? 32 : 40 }}>
                  <Tag 
                    style={{ 
                  ...
                  >
                    {t(`review.type.${review.notification_type}`, review.notification_type)}
                  </Tag>
                </div>
              </div>
              ...
              <div>
                <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? 8 : 12, marginBottom: isMobile ? 8 : 12 }}>
                  ...
                  <Text strong style={{ color: '#374151', fontSize: isMobile ? '14px' : '15px' }}>{t('review.notificationSent')}</Text>
                </div>
                <div style={{ marginLeft: isMobile ? 32 : 40 }}>
                  <Tag 
                  ...
                  >
                    {review.notification_sent ? t('common.yes') : t('common.no')}
                  </Tag>
                </div>
              </div>
              ...
              <div>
                <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? 8 : 12, marginBottom: isMobile ? 8 : 12 }}>
                  ...
                  <Text strong style={{ color: '#374151', fontSize: isMobile ? '14px' : '15px' }}>{t('review.notificationSentAt')}</Text>
                </div>
                <div style={{ marginLeft: isMobile ? 32 : 40, fontSize: isMobile ? '14px' : '15px', color: '#1f2937', fontWeight: 500 }}>
                  {review.notification_sent_at ? dayjs(review.notification_sent_at).format('YYYY-MM-DD HH:mm') : '-'}
                </div>
              </div>
            </div>
          </Card>
        ...
        title={
          <div style={{ display: 'flex', alignItems: 'center', gap: isMobile ? 12 : 16 }}>
            <div style={{
              ...
              <CodeOutlined style={{ color: 'white', fontSize: isMobile ? '18px' : '20px' }} />
            </div>
            <span style={{ fontSize: isMobile ? '18px' : '20px', fontWeight: 600, color: '#1f2937' }}>
