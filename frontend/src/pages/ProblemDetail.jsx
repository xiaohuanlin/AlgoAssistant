...
// Removed unused Typography destructuring and color constants
...
const ProblemDetail = () => {
  ...
  const recordColumns = [
    ...
    {
      title: t('records.executionResult', 'Result'),
  ...
  const reviewColumns = [
    ...
    {
      title: t('review.nextReviewDate', 'Next Review'),
    ...
    {
      title: t('review.reviewCount', 'Count'),
    ...
    },
    {
      ...
      key: 'actions',
      render: (_, review) => (
        <Button type="link" onClick={() => navigate(`/review/${review.id}`)}>
          {t('common.view', 'View')}
        </Button>
      ),
    },
              ...
              >
                <div
                  dangerouslySetInnerHTML={{
                    __html:
                      problem.description || '<p>No description available</p>',
                  }}
                />
              </div>
            </div>
